...
const AuthPage = (props) => {
  ...
  return (
    <div className="login-page">
      ...
      <style>{`
      .login-page { width: 100vw; padding-top: 3vw;padding-bottom: 3vw; background: linear-gradient(180deg, rgba(150,84,150,660) 7%, rgba(117,84,160,1) 17%, rgba(106,95,168,1) 29%, rgba(99,103,174,1) 44%, rgba(87,116,184,1) 66%, rgba(70,135,198,1) 83%, rgba(44,163,219,1) 96%, rgba(22,188,237,1) 100%, rgba(0,212,255,1) 100%); }
